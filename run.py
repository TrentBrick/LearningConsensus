...
def initialize_parameters():
    ...
    parser.add_argument("--honest_correct_commit", action ='store', type=float, default = [-50], nargs='+')
    ...
    parser.add_argument("--termination_reward_partial", action='store', type=float, default=[25], nargs='+')
    parser.add_argument("--safety_reward", action='store', type=float, default=[31.25], nargs='+')
