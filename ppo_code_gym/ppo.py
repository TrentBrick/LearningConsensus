...
def ppo(env_fn, params, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    for epoch in range(epochs):
        ...
        logger.log_tabular('Correct Commits', single_correct)
        logger.log_tabular('Honest wins', all_correct)
        logger.log_tabular('Win Percentage', all_correct/sims)
        logger.log_tabular('Average Rounds', rounds/sims)
